...
import vstr.service.VideoService;
...
public class UserController {
	...
	//api para ver el mis vides de forma correcta
	...
	public String userVideos(Model model, Principal principal) {
		try {
			...
			List<Video> videos = videoService.getVideosByUserEmail(email); // Implementa este método en tu servicio
